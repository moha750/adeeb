    ...
    <main className="py-16">
      <Container>
        ...
        <p className="mt-2 max-w-2xl text-content-muted">
          ...
          يحمل الصورةَ والاسمَ والموضع، ونصفٌ فاتحٌ للحقائق (شارةُ الحالة تُقرأ فوقه ولا تصير مُلصَقًا
          فوق التدرّج). والموضعُ يُقال بوحدته («قائد لجنة الفعاليات») لا رتبةً عارية، ولا سلسلةَ
          انتماءٍ فوقها: المجلسُ والقسمُ مكانُهما «مسيرتي» وشجرةُ الهيكلة، فلا يُقالان ثلاثَ مرّات.
        ...
        <div className="mt-12 space-y-12">
          <section>
            <Label>نشط، قائدُ لجنة</Label>
            <MembershipCard
              name="بشائر فاروق الحداد"
              role="قائد لجنة الفعاليات"
              status="active"
              gender="female"
          ...
          <section>
            <Label>نشط، الإدارة العليا</Label>
            <MembershipCard
          ...
          <section>
            <Label>منصبٌ ممتدٌّ على تسع لجان: تُسرَد في «مسيرتي» لا على البطاقة</Label>
            <MembershipCard
          ...
          <section>
            <Label>غير نشط، لا منصب بعد</Label>
