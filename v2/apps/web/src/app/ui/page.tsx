...
const GROUPS: { title: string; pages: [string, string][] }[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      ["membership", "بطاقة العضويّة"], ["result-card", "بطاقة نتيجة الانتخاب"], ["candidacy/states", "سِجلّ ترشُّحي: كل الحالات"], ["candidacy/apply", "معاينة صفحة الترشّح"], ["candidacy/run", "محاكي الترشُّح"], ["candidacy/vote", "محاكي التصويت"], ["auth", "شاشة المصادقة"], ["join", "صفحة الانضمام"], ["account-deletion", "الخروج من أديب لكلّ دور"],
    ],
  },
  {
