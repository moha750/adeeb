...
/**
 * **شاشةُ إعدادات الباركود في نافذةٍ حيّة** — الغرفةُ خلف تسجيل الدخول، فلا تُرى للحكم عليها.
...
/** شريكان: قارئٌ ومحرّر، ومرشّحون للمشاركة — كي تُرى بطاقةُ الشركاء ونافذتُها هنا. */
const SHARES = [
  { userId: "u1", name: "نورة الدوسري", access: "edit" as const },
  { userId: "u2", name: "عبد الله بن سعد", access: "read" as const },
];
const CANDIDATES = [
  { id: "u3", name: "سارة القحطاني" },
  { id: "u4", name: "فيصل العتيبي" },
  { id: "u5", name: "ريم الشمري" },
];
      ...
      <div className="ash">
        <div className="ash-main">
          ...
          <div className="ash-content">
            <QrSettingsView link={LINK} schedules={[]} shares={SHARES} candidates={CANDIDATES} canManage />
          </div>
