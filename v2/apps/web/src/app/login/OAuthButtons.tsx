...
/**
 * **الدخول بمزوّدٍ اجتماعيّ — لمن له حسابٌ في أديب وحده.**
 *
 * لا يُنشئ هذا الزرُّ حسابًا ولا يمنح عضويّة: من له حسابٌ ببريده المؤكَّد تُضمّ هويّةُ قوقل
 * إليه (ربطٌ تلقائيّ في Supabase) فيدخل بقدراته كما هي، ومن لا حساب له يردّه خطّافُ القاعدة
 * `hook_block_oauth_signup` قبل أن يُكتب صفُّه. فالزرُّ **بابٌ ثانٍ للقائم** لا بابُ تسجيل.
 *
