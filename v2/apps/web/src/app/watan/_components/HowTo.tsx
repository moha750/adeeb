...
const WORDS = [
  ...
  { w: "تلاحم", ic: <Magnet />, p: "مغناطيس", s: "يجذب إليك الحروفَ والأكواب من المسارات الثلاثة." },
  { w: "ثبات", ic: <Hourglass />, p: "تمهّل", s: "يبطئ جريك 28٪ فتثبت خطاك." },
];
    ...
    <>
      ...
      <div className="wtna-body">
        <div className="wtna-card">
          ...
          <ul className="wtna-moves">
            {MOVES.map((m) => (
              <li key={m.b} className="wtna-move">
                <span className="wtna-move-ic" aria-hidden="true">{m.ic}</span>
                <b>{m.b}</b>
                <span>{m.s}</span>
              </li>
            ))}
        ...
        <div className="wtna-card">
          ...
          <ul className="wtna-items">
            {HURDLES.map((h) => (
              <li key={h.b} className="wtna-item">
                <span className="wtna-item-ic" aria-hidden="true">{h.ic}</span>
                <span>
                  <b>{h.b}</b>
                  <span>{h.s}</span>
                </span>
        ...
        <div className="wtna-card">
          ...
          <ol className="wtna-words">
            {WORDS.map((x) => (
              <li key={x.w} className="wtna-word">
                <span className="wtna-word-w">{x.w}</span>
                <span className="wtna-word-p">
                  <b>
                    {x.ic}
                    {x.p}
                  </b>
        ...
        <div className="wtna-card">
          ...
          <ul className="wtna-items">
            {TIPS.map((t) => (
              <li key={t.s} className="wtna-item">
                <span className="wtna-item-ic" aria-hidden="true">{t.ic}</span>
                <span>{t.s}</span>
              </li>
            ))}
          </ul>
