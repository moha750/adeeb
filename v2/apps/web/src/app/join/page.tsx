 ...
 *
 * زرُّ «انضمّ إلينا» في الرأس والهبوط يقصد هذا المسار وحده، لأنّ الرأسَ مكوّنٌ عميليٌّ في صفحاتٍ
 * ساكنةٍ لا يعرف الجلسة — فلو أراد أن يفرّق بين زائرٍ وعضوٍ لَصارت كلُّ صفحةٍ عامّةٍ ديناميّة.
 * فالفرقُ يقع ههنا مرّةً واحدة، وكلٌّ يُساق إلى منزلته:
 *
 * | القاصد | يُساق إلى |
 * |---|---|
