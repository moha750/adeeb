...
// والفرق ليس لفظيًّا: قائد اللجنة ونائبها **خارج** السلطة عمدًا (`membership_authority`)، وهما
// أوّل من يحتاج المشرف معرفته؛ ومشرف الضمان بلا سلطةٍ أصلًا فكانت شاشتُه ستُولد فارغة.
//
