...
const GUIDES: { q: string; a: ReactNode }[] = [
  {
    q: "التنقّل في اللوحة",
    a: "القائمة الجانبيّة مقسومة إلى: «الانتخابات» لترشّحك وتصويتك وإدارة الدورات، و«العضوية» لإدارة الأعضاء، و«التفاعل» للفعاليّات والاستبيانات، و«المحتوى» لما يظهر في الصفحة الرئيسيّة، و«النظام» للصلاحيّات وإحصاءات الزوّار.",
  },
  {
