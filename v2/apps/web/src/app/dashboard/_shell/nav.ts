...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // **معرفة ديبو** (٢٠٢٦-٠٨-٢٢) — بندٌ **مسطّحٌ** بجوار سجلّه لا مجموعةٌ تطويه:
      // جُرّبت المجموعةُ فكشف البناءُ أنّ `MobileNav` يرسم كلَّ بندٍ رابطًا (`it.href!`)
      // ولا يعرف الأبناء، واللوحةُ منتَجُ جوّالٍ قبل كلّ شيء. وهو بندان لفعلٍ واحدٍ في
