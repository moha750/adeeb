              ...
              <>
                ...
                <p className="org-modal-warn">
                  {unit.kind === "admin"
                    ...
                    : `يصير عضوًا في ${unit.name}. والعضويّة في اللجان تتعدّد — فمن كان عضوًا في لجنةٍ أخرى بقي فيها، وهذا ضمٌّ لا نقل.`}
                </p>
              </>
            ) : (
              <p className="org-modal-warn">لا مرشّح — أعضاء النادي كلّهم في هذه الوحدة.</p>
            )
          ) : null}
