...
export type Column<T> = {
  ...
  /**
   * أيقونةُ الحقيقة في **الكرت المضغوط** حين تُعرض القيمةُ بلا تسمية (`bareFacts`):
   * الرسمُ يقول ما تقوله الكلمةُ ولا يُنفق عليها نصفَ عرض الجوّال. ولا أثرَ لها في الجدول:
   * الترويسةُ فوق العمود تسمّيه هناك (أمرُ المالك ٢٠٢٦-٠٨-٢٥).
   */
