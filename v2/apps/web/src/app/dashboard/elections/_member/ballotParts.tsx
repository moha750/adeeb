...
/**
 * وسمُ ورقة الناخب في بطاقته.
 *
 * **ولا يُلبَس ثوبَ «غير متاح» الرماديّ** (ق٧): الورقةُ ليست معطوبةً ولا ناقصة، وإنّما
 * اللائحةُ صرفت يدَ صاحبها عنها. فتبقى بهيئة أخواتها كاملةً، ويُنزع عنها ما يُختار به
 * وحدَه، وتُوسَم باسمها. والرقمُ يبقى، فبه يعرف الناخبُ موضعَه بين المرشّحين.
 */
export function SelfTag() {
  return <Badge tone="info" variant="soft" className="ms-auto">ترشّحك</Badge>;
}
