...
export function BallotStations({ election, candidates, pending, onCast, opener, onFileFail }: {
  ...
  if (sole) {
    /* **ولا يبلغها مرشّحُها**: المرشّحُ الوحيد يرى مقعدَه ولا يفعل فيه (قرار المالك
       ٢٠٢٦-٠٨-١٥)، وغرفةُ الاقتراع تصرفه إلى وجه الاطّلاع بـ`election.viewOnly` قبل هذا
       الفرع. فلا شاشةَ ثانيةً تُبنى له ههنا، ولا سؤالَ يُوجَّه إلى أحدٍ عن نفسه. */
    return (
      <div className="blt">
