...
const nextConfig: NextConfig = {
  ...
  /**
   * **مُصغِّرُ الصور يُفتَح لدلو R2** — لأجل غلاف شاشة القفل.
   *
   * شعارُ البرنامج يُرفَع بمقاسه الأصليّ (قِيس: ٥٨٣٤×٥٨٣٤ و٤٨٤ كيلوبايت)، وآيفون
   * يتجاهل غلافًا بهذا الثقل فتظهر البطاقةُ نصًّا بلا صورة. وبدل أن نطلب رفعًا
   * جديدًا لكلّ برنامج، يمرّ الغلافُ بمُصغِّر Next فيصل صغيرًا.
   *
   * والنطاقُ بنمطٍ لا باسمٍ صريح: عنوانُ الدلو في متغيّر بيئة وقد يتبدّل.
   */
  images: {
    remotePatterns: [{ protocol: "https", hostname: "**.r2.dev" }],
  },
  /**
   * **«دربك خضر» تُلعَب على `/games/darbak-khadar/play`** — والملفُّ نفسُه `public/games/darbak-khadar/game.html`.
   *
   ...
   * **في الأصل نفسِه** مع أبوابها (`/games/darbak-khadar/api/*`): فكوكيزُ اللاعب تُرسَل بلا CORS ولا
