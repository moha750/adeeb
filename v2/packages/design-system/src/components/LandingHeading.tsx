...
const titleFill: CSSProperties = {
  ...
  color: "transparent",
  /**
   * **صندوقُ الطلاء يوسَّع من الطرفين.** `background-clip: text` يقصّ التدرّجَ عند صندوق
   * النصّ، وصندوقُ السطر أضيقُ من مدى الحرف العربيّ في الطرفين:
   * · **أعلى**: التشكيلُ (شدّةٌ وحركات) يعلوه فيسقط.
   * · **أسفل**: ذيولُ «ح» و«ج» و«ي» تنزل عنه فتُرى مبتورة (رآها المالك ٢٠٢٦-٠٨-٣١).
   *
   * ولا يزيح هذا التخطيطَ لأنّ العنوان عنصرٌ **سطريّ**: حشوُه لا يدخل في ارتفاع السطر.
   */
  paddingTop: "0.35em",
  paddingBottom: "0.3em",
};
