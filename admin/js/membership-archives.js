...
function showCycleDetailsModal() {
    ...
    modal.className = 'modal modal-xl active';
    modal.innerHTML = `
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="modal-close" onclick="this.closest('.modal').classList.remove('active'); document.querySelector('.modal-backdrop').classList.remove('active'); setTimeout(() => { this.closest('.modal').remove(); document.querySelector('.modal-backdrop').remove(); }, 300);">
