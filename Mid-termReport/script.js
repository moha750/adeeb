...
false},easing:function(a,b,c,d,e){return d*Math.sqrt(1-(b=b/e-1)*b)+c}},a);this.data(b);j()}else delete b.effect}});f.isTouch=t;f.mouseEvents=q;f.cssPrefix=S;f.cssTransitionEnd=function(){var a,b=document.createElement("fakeelement"),c={transition:"transitionend",OTransition:"oTransitionEnd",MSTransition:"transitionend",MozTransition:"transitionend",WebkitTransition:"webkitTransitionEnd"};for(a in c)if(void 0!==b.style[a])return c[a]};f.findPos=C})(jQuery);
	...
	function initShareSection() {
		...
		var title = document.title || 'التقرير النصفي لأنشطة أدِيب';
		var text = 'اطّلع على التقرير: ' + title;
		
		var encodedUrl = encodeURIComponent(url);
		var encodedText = encodeURIComponent(text);
		
		var $toast = $('#shareToast');
		var $toastMessage = $('#shareToastMessage');
		
		function showToast(message) {
			if ($toastMessage.length && message) {
		...
		$('#shareX').on('click', function() {
			var shareUrl = 'https://twitter.com/intent/tweet?text=' + encodedText + '&url=' + encodedUrl;
		...
		$('#copyLink').on('click', function() {
			...
			var $copyText = $copyBtn.find('span');
			var originalText = $copyText.length ? $copyText.text() : '';
			var revertTimer;
			
			function setCopiedState() {
				$copyBtn.addClass('copied');
				if ($copyText.length) {
					$copyText.text('تمّ النسخ!');
				}
				clearTimeout(revertTimer);
				revertTimer = setTimeout(function() {
					$copyBtn.removeClass('copied');
					if ($copyText.length) {
						$copyText.text(originalText || 'نسخ الرابط');
					}
				}, 2000);
			}
			...
			if (navigator.clipboard && window.isSecureContext) {
				navigator.clipboard.writeText(url).then(onCopied).catch(onCopyError);
				return;
			}
	...
	function initFlipbook(pageWidth, pageHeight) {
		...
		var totalPages = $("#flipbook").children().length;
		...
		try {
			$("#flipbook").turn({
				...
				elevation: 50,
				duration: 1000,
				pages: totalPages, // عدد الصفحات الفعلي
...
20: 'الصفحة العشرون',
21: 'الصفحة الحادية والعشرون',
22: 'الصفحة الثانية والعشرون',
23: 'الصفحة الثالثة والعشرون',
24: 'الصفحة الرابعة والعشرون',
25: 'الصفحة الخامسة والعشرون',
26: 'الصفحة السادسة والعشرون',
27: 'الصفحة السابعة والعشرون',
28: 'الصفحة الثامنة والعشرون',
29: 'الصفحة التاسعة والعشرون',
30: 'الصفحة الثلاثون',
31: 'الصفحة الحادية والثلاثون',
32: 'الصفحة الثانية والثلاثون',
33: 'الصفحة الثالثة والثلاثون',
34: 'الصفحة الرابعة والثلاثون',
35: 'الصفحة الخامسة والثلاثون',
36: 'الصفحة السادسة والثلاثون',
37: 'الصفحة السابعة والثلاثون',
38: 'الصفحة الثامنة والثلاثون',
39: 'الصفحة التاسعة والثلاثون',
40: 'الصفحة الأربعون',
41: 'الصفحة الحادية والأربعون',
42: 'الصفحة الثانية والأربعون',
43: 'الصفحة الثالثة والأربعون',
44: 'الصفحة الرابعة والأربعون',
45: 'الصفحة الخامسة والأربعون',
46: 'الصفحة السادسة والأربعون',
47: 'الصفحة السابعة والأربعون',
48: 'الصفحة الثامنة والأربعون',
49: 'الصفحة التاسعة والأربعون',
50: 'الصفحة الخمسون',
51: 'الصفحة الحادية والخمسون',
52: 'الصفحة الثانية والخمسون',
53: 'الصفحة الثالثة والخمسون',
54: 'الصفحة الرابعة والخمسون',
55: 'الصفحة الخامسة والخمسون',
56: 'الصفحة السادسة والخمسون',
57: 'الصفحة السابعة والخمسون',
58: 'الصفحة الثامنة والخمسون',
59: 'الصفحة التاسعة والخمسون',
60: 'الصفحة الستون',
61: 'الصفحة الحادية والستون',
62: 'الصفحة الثانية والستون',
63: 'الصفحة الثالثة والستون',
64: 'الصفحة الرابعة والستون',
65: 'الصفحة الخامسة والستون',
66: 'الصفحة السادسة والستون',
67: 'الصفحة السابعة والستون',
68: 'الصفحة الثامنة والستون',
69: 'الصفحة التاسعة والستون',
70: 'الصفحة السبعون',
71: 'الصفحة الحادية والسبعون',
72: 'الصفحة الثانية والسبعون',
73: 'الصفحة الثالثة والسبعون',
74: 'الصفحة الرابعة والسبعون',
75: 'الصفحة الخامسة والسبعون',
76: 'الصفحة السادسة والسبعون',
77: 'الصفحة السابعة والسبعون',
78: 'الصفحة الثامنة والسبعون',
79: 'الصفحة التاسعة والسبعون',
80: 'الغلاف الخلفي'
			};
