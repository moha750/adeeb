...
-- النسخة: 20260426183901   الاسم: activity_lifecycle_whatsapp_attendance_certificate
...
-- 4. Trigger يمنع التعديل المباشر للأعمدة الحساسة
...
-- 9. RPC: قائمة الأنشطة في النافذة الحالية
...
REVOKE ALL ON SEQUENCE certificate_serial_seq FROM PUBLIC;
REVOKE ALL ON SEQUENCE certificate_serial_seq FROM anon;
REVOKE ALL ON SEQUENCE certificate_serial_seq FROM authenticated;
