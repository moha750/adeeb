-- ٢٠٢٦-٠٩-٠٥ — «جُدد مقابل عائدين» تصير ثلاثةَ أصناف: منتسبو أدِيب أوّلًا.
--
-- طلبها المالكُ صنفًا في الحلقة، وقد بيّنتُ أنّ العضويّة **بُعدٌ متعامد** على القسمة لا قسمٌ
-- ثالثٌ فيها: العضوُ نفسُه إمّا جديدٌ أو عائد، فإضافتُه شريحةً فوقهما تجعل مجموعَ الأجزاء
-- أكبرَ من الكلّ. فنُفِّذت **بالأولويّة**: يُفرَز المنتسبون أوّلًا، ثمّ يُقسَم الباقي جديدًا
-- وعائدًا — فتجمع الشرائحُ الثلاث عددَ الزوّار بالضبط، ولكلّ زائرٍ موضعٌ واحدٌ لا اثنان.
--
-- والزائرُ «منتسب» إن حمل **أيُّ** مشاهدةٍ له في المدّة هويّةَ حسابٍ داخل (`bool_or`)، لا أن
-- تحملها كلُّها: من تصفّح ثمّ دخل بحسابه في الزيارة نفسِها منتسبٌ لا زائرٌ مجهول.
--
-- ولا يُمسّ التوقيعُ ولا الصلاحيّات: `create or replace` وحدَها، وسائرُ الحمولة كما كانت.
