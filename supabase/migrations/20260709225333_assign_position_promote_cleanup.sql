...
-- النسخة: 20260709225333   الاسم: assign_position_promote_cleanup
...
begin
  ...
  select role_name into v_role_name from roles where id = p_role;
  ...
  from user_roles
  where user_id = p_user and role_id = p_role and committee_id is not distinct from p_committee
  limit 1;
