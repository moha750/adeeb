-- ٢٠٢٦-٠٩-٠٥ — كلُّ مصدرٍ يظهر باسمه، لا قائمةً مغلقةً أُحدّثها بيدي.
--
-- كان ما لم أسمِّه يقع في «مواقعُ أخرى»، فلو جاء زوّارٌ من موقعٍ جديدٍ لم يُعرَف حتى أضيفه.
-- صار المجهولُ يظهر باسم نطاقه، والتحديدُ للدمج فقط. والذيلُ بعد الثاني عشر يُجمع.
